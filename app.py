...
# Custom CSS for clean light mode design - Override browser dark mode
st.markdown("""
<style>
    ...
    /* Force all backgrounds and text to light mode */
    ...
    /* Selectboxes - force white background */
    [data-baseweb="select"] {
